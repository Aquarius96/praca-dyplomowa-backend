...
namespace PracaDyplomowaBackend.Repo.Migrations
{
    ...
    [Migration("20180924095414_SmallNamingChanges")]
            ...
            modelBuilder.Entity("PracaDyplomowaBackend.Data.DbModels.Common.Book", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Added = new DateTime(2018, 9, 24, 9, 54, 13, 458, DateTimeKind.Utc), Description = "Jedyne w Polsce wydanie zawierające wszystkie opowiadania i nowele Arthura Conan Doyle’a o detektywie wszech czasów.", PagesCount = 1108, PhotoUrl = "https://iupac.org/cms/wp-content/uploads/2018/05/default-avatar.png", Released = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Księga wszystkich dokonań Sherlocka Holmesa" },
                        new { Id = 2, Added = new DateTime(2018, 9, 24, 9, 54, 13, 458, DateTimeKind.Utc), Description = "Pierwsza część sagi o wiedźminie Geralcie z Rivii.", PagesCount = 332, PhotoUrl = "https://iupac.org/cms/wp-content/uploads/2018/05/default-avatar.png", Released = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Ostatnie życzenie" },
                        new { Id = 3, Added = new DateTime(2018, 9, 24, 9, 54, 13, 458, DateTimeKind.Utc), Description = "Pełne magii i przygód wspaniałe preludium do „Władcy Pierścieni”.", PagesCount = 304, PhotoUrl = "https://iupac.org/cms/wp-content/uploads/2018/05/default-avatar.png", Released = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Hobbit" }
                    );
                });
            ...
            modelBuilder.Entity("PracaDyplomowaBackend.Data.DbModels.Common.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("3f38fcb6-fd6e-43c9-d30b-08d6119ae085"), Added = new DateTime(2018, 9, 24, 9, 54, 13, 456, DateTimeKind.Utc), ConfirmationCode = new Guid("00000000-0000-0000-0000-000000000000"), Confirmed = true, EmailAddress = "aquarius96@wp.pl", Firstname = "Marcin", Lastname = "Zapadka", Password = "AQAAAAEAACcQAAAAELFL9kOX6RSdfEY6XayG8rRXip7ST1br7qyVmlRQ4wlaiFGAQDyzpvUsh9mAH1RdLg==", PhotoUrl = "https://iupac.org/cms/wp-content/uploads/2018/05/default-avatar.png", Username = "Administrator" }
                    );
                });
